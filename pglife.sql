...
CREATE TABLE `properties` (
  ...
  `rating_clean` float(3,2) NOT NULL,
  `rating_food` float(3,2) NOT NULL,
  `rating_safety` float(3,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'tirtham77@gmail.com', 'JIS20221047', 'Tirtha Mukherjee', '7362995858', 'male', 'JISCE');
